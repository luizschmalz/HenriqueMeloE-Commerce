...
.title-container {
  background: transparent; /* Background color of the black container */
...
.containerequipe:hover .integrante img{
    opacity: 0;
}
.containerequipe{
    display: flex;
