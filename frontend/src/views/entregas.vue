<template>
    ...
    <div class="login-page">
      <div class="login-form">
        <h1 class="page-title">Entre na sua conta</h1>
  ...
  if (!response.ok) {
    ...
    router.push('/paginaEntregador');
    store.dispatch('setEmail', email); // Dispatch an action to update the email in the store
  }
};
